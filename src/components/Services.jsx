...
const Services = () => {
  return (
    <section className="py-[60px] max-w-[1350px] mx-auto">
      ...
      <div className="services-grid px-5 grid grid-cols-[1fr] sm:grid-cols-[repeat(2,1fr)] gap-7 lg:grid-cols-[repeat(3,1fr)]">
